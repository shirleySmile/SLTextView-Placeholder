...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SLTVPlaceholder.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/shirleySmile/SLTVPlaceholder'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'shirleySmile' => '276482207@qq.com' }
  s.source           = { :git => 'https://github.com/shirleySmile/SLTVPlaceholder.git', :tag => s.version.to_s }
